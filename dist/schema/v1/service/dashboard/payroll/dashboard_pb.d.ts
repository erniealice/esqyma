...
import type { PayrollRun } from "../../../domain/payroll/payroll_run/payroll_run_pb";
import type { PayrollRemittance } from "../../../domain/payroll/payroll_remittance/payroll_remittance_pb";
import type { Message } from "@bufbuild/protobuf";
/**
 * Describes the file service/dashboard/payroll/dashboard.proto.
 */
export declare const file_service_dashboard_payroll_dashboard: GenFile;
/**
 * PayrollStats are the four dashboard stats for payroll.
 *
 * @generated from message service.dashboard.payroll.v1.PayrollStats
 */
export type PayrollStats = Message<"service.dashboard.payroll.v1.PayrollStats"> & {
    /**
 ...
 *
 * @generated from message service.dashboard.payroll.v1.GetPayrollDashboardRequest
 */
export type GetPayrollDashboardRequest = Message<"service.dashboard.payroll.v1.GetPayrollDashboardRequest"> & {
    /**
 ...
 *
 * @generated from message service.dashboard.payroll.v1.GetPayrollDashboardResponse
 */
export type GetPayrollDashboardResponse = Message<"service.dashboard.payroll.v1.GetPayrollDashboardResponse"> & {
    /**
    ...
    error?: Error;
    /**
     * @generated from field: service.dashboard.payroll.v1.PayrollStats stats = 3;
     */
    stats?: PayrollStats;
    /**
