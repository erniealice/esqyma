 ...
 */
export declare const file_domain_entity_location_dashboard_dashboard: GenFile;
/**
 * LocationStats are the four stat cards shown at the top of the location
 * dashboard: Total / Active / Regions / Areas Count.
 *
 * @generated from message domain.entity.location.dashboard.v1.LocationStats
 */
export type LocationStats = Message<"domain.entity.location.dashboard.v1.LocationStats"> & {
    /**
 ...
 *
 * @generated from message domain.entity.location.dashboard.v1.LocationAreaCount
 */
export type LocationAreaCount = Message<"domain.entity.location.dashboard.v1.LocationAreaCount"> & {
    /**
 ...
 *
 * @generated from message domain.entity.location.dashboard.v1.GetLocationDashboardRequest
 */
export type GetLocationDashboardRequest = Message<"domain.entity.location.dashboard.v1.GetLocationDashboardRequest"> & {
    /**
 ...
 *
 * @generated from message domain.entity.location.dashboard.v1.GetLocationDashboardResponse
 */
export type GetLocationDashboardResponse = Message<"domain.entity.location.dashboard.v1.GetLocationDashboardResponse"> & {
    /**
    ...
    error?: Error;
    /**
     * @generated from field: domain.entity.location.dashboard.v1.LocationStats stats = 3;
     */
    stats?: LocationStats;
    /**
    ...
    /**
     * @generated from field: repeated domain.entity.location.dashboard.v1.LocationAreaCount top_areas = 5;
     */
