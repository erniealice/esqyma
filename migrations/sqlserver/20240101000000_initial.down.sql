...
IF OBJECT_ID('dbo.client', 'U') IS NOT NULL
  ALTER TABLE [client] DROP CONSTRAINT IF EXISTS [fk_client_category_id];
IF OBJECT_ID('dbo.workspace', 'U') IS NOT NULL
  ALTER TABLE [workspace] DROP CONSTRAINT IF EXISTS [fk_workspace_workflow_template_id];
