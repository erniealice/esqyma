...
CREATE TABLE [deferred_revenue] (
  ...
  [total_amount] FLOAT NOT NULL,
  [recognized_amount] FLOAT NOT NULL DEFAULT 0,
  [remaining_amount] FLOAT NOT NULL,
  [start_date] BIGINT NOT NULL,
  [end_date] BIGINT NOT NULL,
...
CREATE TABLE [asset_revaluation] (
  ...
  [previous_carrying_amount] FLOAT NOT NULL,
  [new_fair_value] FLOAT NOT NULL,
  [revaluation_amount] FLOAT NOT NULL,
  [is_increase] BIT NOT NULL,
  [recognized_in_pnl] FLOAT NOT NULL,
  [recognized_in_oci] FLOAT NOT NULL,
  [revaluation_surplus_balance] FLOAT NOT NULL,
...
CREATE TABLE [petty_cash_fund] (
  [id] NVARCHAR(MAX) PRIMARY KEY,
  [name] NVARCHAR(MAX) NOT NULL,
  [authorized_amount] FLOAT NOT NULL,
