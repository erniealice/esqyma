...
CREATE TABLE [supplier] (
  ...
  [billing_currency] NVARCHAR(MAX) NULL,
...
CREATE TABLE [product_price_plan] (
  ...
  [product_plan_id] NVARCHAR(MAX) NOT NULL,
  [billing_amount] BIGINT NOT NULL,
  [billing_currency] NVARCHAR(MAX) NOT NULL,
  [billing_treatment] NVARCHAR(MAX) NOT NULL,
  ...
  CONSTRAINT [fk_product_price_plan_product_plan_id] FOREIGN KEY ([product_plan_id]) REFERENCES [product_plan]([id])
);
...
CREATE TABLE [fulfillment] (
  ...
  [delivery_mode] NVARCHAR(MAX) NOT NULL,
  [status] NVARCHAR(MAX) NOT NULL,
  [provider_status] NVARCHAR(MAX) NOT NULL,
  [provider_reference] NVARCHAR(MAX) NOT NULL,
...
CREATE TABLE [product_plan] (
  ...
  [product_variant_id] NVARCHAR(MAX) NULL,
  ...
  CONSTRAINT [fk_product_plan_product_variant_id] FOREIGN KEY ([product_variant_id]) REFERENCES [product_variant]([id])
);
...
CREATE TABLE [activity_expense] (
  ...
  [expense_category_id] NVARCHAR(MAX) NULL,
  [payment_method] NVARCHAR(MAX) NULL,
  [markup_pct_override] FLOAT NULL,
...
CREATE TABLE [product] (
  ...
  [product_kind] NVARCHAR(MAX) NOT NULL,
  [delivery_mode] NVARCHAR(MAX) NOT NULL,
  [tracking_mode] NVARCHAR(MAX) NOT NULL,
  [unit] NVARCHAR(MAX) NULL,
  [variant_mode] NVARCHAR(MAX) NOT NULL DEFAULT none,
...
CREATE TABLE [workspace] (
  ...
  [date_modified] BIGINT NULL,
  [active] BIT NOT NULL DEFAULT true,
  [functional_currency] NVARCHAR(MAX) NULL,
...
-- Table: event_tag_assignment
CREATE TABLE [event_tag_assignment] (
  [id] NVARCHAR(MAX) PRIMARY KEY,
  [event_id] NVARCHAR(MAX) NOT NULL,
  [event_tag_id] NVARCHAR(MAX) NOT NULL,
  ...
  CONSTRAINT [uq_event_tag_assignment_1] UNIQUE ([event_id], [event_tag_id])
);
...
CREATE TABLE [price_plan] (
  ...
  [price_schedule_id] NVARCHAR(MAX) NULL,
  [billing_kind] NVARCHAR(MAX) NOT NULL,
  [amount_basis] NVARCHAR(MAX) NOT NULL,
