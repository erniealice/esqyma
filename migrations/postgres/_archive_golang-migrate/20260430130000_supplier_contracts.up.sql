...
-- Rationale: Introduces the four supplier-commitment entities — SupplierContract,
--            SupplierContractLine, ProcurementRequest, ProcurementRequestLine —
--            and adds FK back-edges from PurchaseOrder, PurchaseOrderLineItem,
--            Expenditure, ExpenditureLineItem, and Prepayment.
--
--            See plan §3 (proto sketch), §10 (codex SupplierContractLine
--            proposal), §11 (reconciled scope), and progress.md §P1.4 for the
--            FK back-edge inventory.
--
--            Balance-field semantics on supplier_contract follow the
--            single-write-boundary rule (plan §11.7 risk #5): only the
--            SupplierContractDomainService use cases may UPDATE
--            committed_amount / released_amount / billed_amount /
--            remaining_amount. Adapter writes outside that boundary are
--            forbidden.
...
-- ============================================================================
-- FK back-edges on existing tables (plan §11.5)
-- ============================================================================
