...
CREATE TABLE "activity_expense" (
  ...
  "markup_pct_override" DOUBLE PRECISION NULL,
...
CREATE TABLE "purchase_order" (
  ...
  "blanket_total_quantity" DOUBLE PRECISION NOT NULL,
  "blanket_released_quantity" DOUBLE PRECISION NOT NULL,
  "notes" TEXT NULL,
  "reference_number" TEXT NULL,
  "active" BOOLEAN NOT NULL DEFAULT true,
  "date_created" BIGINT NULL,
...
CREATE TABLE "job_settlement" (
  ...
  "active" BOOLEAN NOT NULL,
  "workspace_id" TEXT NULL,
  "billed_quantity" DOUBLE PRECISION NULL,
...
CREATE TABLE "purchase_order_line_item" (
  ...
  "quantity_billed" DOUBLE PRECISION NOT NULL,
  "unit_price" BIGINT NOT NULL,
  "total_price" BIGINT NOT NULL,
  "location_id" TEXT NULL,
...
CREATE TABLE "price_plan" (
  ...
  "billing_cycle_value" INTEGER NULL,
  "billing_cycle_unit" TEXT NULL,
  "default_term_value" INTEGER NULL,
