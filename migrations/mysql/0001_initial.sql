...
CREATE TABLE `depreciation_schedule` (
  ...
  `opening_book_value` DOUBLE NOT NULL,
  `depreciation_amount` DOUBLE NOT NULL,
  `accumulated_depreciation` DOUBLE NOT NULL,
  `closing_book_value` DOUBLE NOT NULL,
...
CREATE TABLE `deferred_revenue` (
  ...
  `total_amount` DOUBLE NOT NULL,
  `recognized_amount` DOUBLE NOT NULL DEFAULT 0,
  `remaining_amount` DOUBLE NOT NULL,
  `start_date` BIGINT NOT NULL,
  `end_date` BIGINT NOT NULL,
...
CREATE TABLE `product_variant` (
  ...
  `product_id` TEXT NOT NULL,
  `sku` TEXT NOT NULL,
  `price_override` DOUBLE NOT NULL,
  `active` BOOLEAN NOT NULL DEFAULT true,
  `date_created` BIGINT NULL,
  `date_modified` BIGINT NULL,
...
CREATE TABLE `asset_disposal` (
  ...
  `cost_at_disposal` DOUBLE NOT NULL,
  `accumulated_depreciation_at_disposal` DOUBLE NOT NULL,
  `book_value_at_disposal` DOUBLE NOT NULL,
  `gain_or_loss` DOUBLE NOT NULL,
...
CREATE TABLE `purchase_order` (
  ...
  `blanket_start_date` BIGINT NULL,
  `blanket_end_date` BIGINT NULL,
...
CREATE TABLE `asset_revaluation` (
  ...
  `previous_carrying_amount` DOUBLE NOT NULL,
  `new_fair_value` DOUBLE NOT NULL,
  `revaluation_amount` DOUBLE NOT NULL,
  `is_increase` BOOLEAN NOT NULL,
  `recognized_in_pnl` DOUBLE NOT NULL,
  `recognized_in_oci` DOUBLE NOT NULL,
  `revaluation_surplus_balance` DOUBLE NOT NULL,
...
CREATE TABLE `petty_cash_fund` (
  `id` TEXT PRIMARY KEY,
  `name` TEXT NOT NULL,
  `authorized_amount` DOUBLE NOT NULL,
