...
Write-Host ""
Write-Host "Releasing module: github.com/erniealice/esqyma@$tag" -ForegroundColor Cyan
Write-Host ""
...
$proxyUrl = "https://proxy.golang.org/github.com/erniealice/esqyma/@v/$tag.info"
try {
...
Write-Host "Released github.com/erniealice/esqyma@$tag" -ForegroundColor Green
Write-Host "  Verify: go list -m github.com/erniealice/esqyma@$tag" -ForegroundColor White
Write-Host "=" * 50 -ForegroundColor Green
