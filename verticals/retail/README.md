...
| **Client** | [scenarios/client.md](scenarios/client.md) | Walk-in registration, wholesale B2B onboarding, VIP upgrade based on spending |
| **Product** | [scenarios/product.md](scenarios/product.md) | New product with variants, seasonal collection and price list launch, discontinuing a product |
