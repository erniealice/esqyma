...
`esqyma/schema/v1` contains all Protocol Buffer (`.proto`) definitions for the platform. These schemas define the data contracts used across the entire system—backend services, frontend clients, and integrations.
