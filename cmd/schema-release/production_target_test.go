...
func TestMMISForwardUpgradeTargetContract(t *testing.T) {
	...
	u := target.Upgrade
	if u.FromRelease != "postgres/2026.09.2" || u.ConnectionMode != "session" || u.Endpoint != target.Access.Endpoint || u.MigrationRole != "mmis_migrator" || u.RuntimeRole != "mmis_runtime" {
