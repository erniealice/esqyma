...
--
-- Name: zz_ay2627_staff_cleanup_log; Type: TABLE; Schema: audit_trail; Owner: -
--
...
--
-- Name: zz_rds_release_log; Type: TABLE; Schema: audit_trail; Owner: -
--
...
CREATE TABLE audit_trail.zz_rds_release_log (
    ...
    logged_at timestamp with time zone DEFAULT now() NOT NULL,
    revoked_at timestamp with time zone,
    CONSTRAINT ck_zz_rds_release_log_action CHECK ((action = ANY (ARRAY['insert'::text, 'update'::text, 'delete'::text])))
);


--
-- Name: TABLE zz_rds_release_log; Type: COMMENT; Schema: audit_trail; Owner: -
--

COMMENT ON TABLE audit_trail.zz_rds_release_log IS 'Operator-only rollback log for the rating-description-sets data scripts (pre/post images per changed row).';


--
-- Name: zz_term_rename_c1_log; Type: TABLE; Schema: audit_trail; Owner: -
--
...
CREATE TABLE public.evaluation (
    ...
    CONSTRAINT evaluation_subject_arc_chk CHECK ((num_nonnulls(staff_id, subject_client_id) = 1)),
    CONSTRAINT evaluation_subject_drift_chk CHECK (((subject_type = 'associate'::text) = (staff_id IS NOT NULL))),
...
CREATE TABLE public.job_outcome_summary_document_template (
    ...
    date_created bigint,
    date_modified bigint,
    job_template_phase_code text,
    CONSTRAINT ck_jos_doc_tmpl_phase_code CHECK (((job_template_phase_code IS NULL) OR ((job_template_phase_code = lower(btrim(job_template_phase_code))) AND (job_template_phase_code ~ '^[a-z][a-z0-9_]*$'::text)))),
    CONSTRAINT ck_jos_doc_tmpl_validity CHECK (((validity_start IS NULL) OR (validity_end IS NULL) OR (validity_start < validity_end)))
);


--
-- Name: COLUMN job_outcome_summary_document_template.job_template_phase_code; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.job_outcome_summary_document_template.job_template_phase_code IS 'Optional period scope (job_template_phase.code). NULL = whole-year report card; set = that period''s document.';
...
--
-- Name: plan_composition_successor_legacy_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.plan_composition_successor_legacy_backup (
    plan_id text NOT NULL,
    root_job_template_id text CONSTRAINT plan_composition_successor_legacy_root_job_template_id_not_null NOT NULL,
    relation_rows jsonb NOT NULL,
...
CREATE TABLE public.price_plan (
    ...
    client_id text,
    default_escalation_mode text,
    default_escalation_scope text,
    default_escalation_rate_bps integer,
    default_escalation_first_after_months integer,
    default_escalation_every_months integer,
    CONSTRAINT price_plan_escalation_clause_check CHECK (COALESCE((((default_escalation_mode IS NULL) AND (default_escalation_scope IS NULL) AND (default_escalation_rate_bps IS NULL) AND (default_escalation_first_after_months IS NULL) AND (default_escalation_every_months IS NULL)) OR ((default_escalation_mode = 'none'::text) AND (default_escalation_scope IS NULL) AND (default_escalation_rate_bps IS NULL) AND (default_escalation_first_after_months IS NULL) AND (default_escalation_every_months IS NULL)) OR ((default_escalation_mode = 'fixed_percentage'::text) AND ((default_escalation_rate_bps >= 1) AND (default_escalation_rate_bps <= 10000)) AND (default_escalation_scope = 'within_agreement'::text) AND ((default_escalation_first_after_months >= 1) AND (default_escalation_first_after_months <= 1200)) AND ((default_escalation_every_months >= 1) AND (default_escalation_every_months <= 1200))) OR ((default_escalation_mode = 'fixed_percentage'::text) AND ((default_escalation_rate_bps >= 1) AND (default_escalation_rate_bps <= 10000)) AND (default_escalation_scope = 'on_renewal'::text) AND (default_escalation_first_after_months IS NULL) AND (default_escalation_every_months IS NULL))), false))
);
...
--
-- Name: rating_description_set; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.rating_description_set (
    id text NOT NULL,
    workspace_id text NOT NULL,
    code text,
    ...
    date_created bigint,
    date_modified bigint,
    CONSTRAINT rating_description_set_name_nonblank_chk CHECK ((btrim(name) <> ''::text)),
    CONSTRAINT rating_description_set_version_positive_chk CHECK ((version > 0))
);


--
-- Name: rating_description_set_entry; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.rating_description_set_entry (
    id text NOT NULL,
    workspace_id text NOT NULL,
    ...
    date_created bigint,
    date_modified bigint,
    CONSTRAINT rating_description_set_entry_description_nonblank_chk CHECK ((btrim(description) <> ''::text))
);


--
-- Name: rating_description_set_product_plan; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.rating_description_set_product_plan (
    id text NOT NULL,
    workspace_id text NOT NULL,
    rating_description_set_id text CONSTRAINT rating_description_set_produ_rating_description_set_id_not_null NOT NULL,
    product_plan_id text NOT NULL,
    price_schedule_id text NOT NULL,
    active boolean DEFAULT true NOT NULL,
    date_created bigint,
...
CREATE TABLE public.subscription (
    ...
    escalation_first_after_months integer,
    escalation_every_months integer,
    CONSTRAINT subscription_escalation_clause_check CHECK (COALESCE((((escalation_mode IS NULL) AND (escalation_scope IS NULL) AND (escalation_rate_bps IS NULL) AND (escalation_first_after_months IS NULL) AND (escalation_every_months IS NULL)) OR ((escalation_mode = 'none'::text) AND (escalation_scope IS NULL) AND (escalation_rate_bps IS NULL) AND (escalation_first_after_months IS NULL) AND (escalation_every_months IS NULL)) OR ((escalation_mode = 'fixed_percentage'::text) AND ((escalation_rate_bps >= 1) AND (escalation_rate_bps <= 10000)) AND (escalation_scope = 'within_agreement'::text) AND ((escalation_first_after_months >= 1) AND (escalation_first_after_months <= 1200)) AND ((escalation_every_months >= 1) AND (escalation_every_months <= 1200))) OR ((escalation_mode = 'fixed_percentage'::text) AND ((escalation_rate_bps >= 1) AND (escalation_rate_bps <= 10000)) AND (escalation_scope = 'on_renewal'::text) AND (escalation_first_after_months IS NULL) AND (escalation_every_months IS NULL))), false))
);
...
CREATE TABLE public.subscription_group_document_template (
    ...
    date_created bigint,
    date_modified bigint,
    CONSTRAINT ck_sgdt_job_category_required CHECK ((job_category_id IS NOT NULL)),
...
--
-- Name: COLUMN subscription_group_document_template.job_category_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.subscription_group_document_template.job_category_id IS 'Required job category (job_category.id). A binding serves one job category of the group-matrix data source.';
...
CREATE TABLE public.template_task_criteria (
    ...
    workspace_id text,
    rating_mode text,
    rating_scale_id text
);


--
-- Name: template_task_criteria_rating_description; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.template_task_criteria_rating_description (
    id text NOT NULL,
    template_task_criteria_id text CONSTRAINT template_task_criteria_ratin_template_task_criteria_id_not_null NOT NULL,
    score_scale_band_id text CONSTRAINT template_task_criteria_rating_desc_score_scale_band_id_not_null NOT NULL,
    description text NOT NULL,
    sequence_order integer DEFAULT 0 CONSTRAINT template_task_criteria_rating_descripti_sequence_order_not_null NOT NULL,
    active boolean DEFAULT true NOT NULL,
    workspace_id text,
    date_created bigint,
    date_modified bigint,
    CONSTRAINT template_task_criteria_rating_description_nonblank CHECK ((btrim(description) <> ''::text))
);
...
--
-- Name: zz_f2_pos_backup_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f2_pos_backup_20260712 (
    id text,
    job_phase_id text,
    job_id text,
    summary_type text,
...
--
-- Name: zz_f2_pos_precompute_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f2_pos_precompute_20260712 (
    id text,
    job_phase_id text,
    job_id text,
    summary_type text,
...
--
-- Name: zz_f2_task_outcome_backup_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f2_task_outcome_backup_20260712 (
    id text,
    job_task_id text,
    criteria_version_id text,
    criteria_type text,
...
--
-- Name: zz_f3_job_outprod_backup_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f3_job_outprod_backup_20260712 (
    id text,
    output_product_id text
);
...
--
-- Name: zz_f3_product_backup_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f3_product_backup_20260712 (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_f3_product_plan_backup_20260712; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_f3_product_plan_backup_20260712 (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_idremap_20260803; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_idremap_20260803 (
    tbl text NOT NULL,
...
--
-- Name: zz_s8_equality_baseline; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_equality_baseline (
    staff_id text,
    deliv_jobs bigint,
    seat_jobs bigint,
    deliv_minus_seat bigint,
    seat_minus_deliv bigint
);


--
-- Name: zz_s8_job_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_job_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_jobmap; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jobmap (
    sec text,
    umb text,
    surv_tid text,
    donor_tid text,
    ...
    surv_job text,
    donor_job text,
    donor_s2_jp_move text,
    surv_s2_jp_empty text,
    donor_s1_jp_empty text,
    surv_s1_jp_keep text
);


--
-- Name: zz_s8_jp_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jp_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_jt_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jt_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_jtask_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jtask_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_jtp_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jtp_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_jtt_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_jtt_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_pairmap; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_pairmap (
    sec text,
    sec_name text,
    umb text,
    surv_tid text,
    ...
    donor_strand text,
    surv_s1_ph text,
    surv_s2_ph_empty text,
    donor_s2_ph_move text,
    donor_s1_ph_empty text,
    is_arts boolean
);


--
-- Name: zz_s8_pos_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_pos_backup (
    id text,
    job_phase_id text,
    job_id text,
    summary_type text,
...
--
-- Name: zz_s8_pp_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_pp_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_s8_product_backup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_s8_product_backup (
    id text,
    date_created timestamp with time zone,
    date_modified timestamp with time zone,
    active boolean,
...
--
-- Name: zz_t16_job_origin_backup_20260711; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zz_t16_job_origin_backup_20260711 (
    job_id text,
    client_id text,
    old_origin text,
    new_origin text,
...
--
-- Name: zz_ay2627_staff_cleanup_log pk_zz_ay2627_staff_cleanup_log; Type: CONSTRAINT; Schema: audit_trail; Owner: -
--

ALTER TABLE ONLY audit_trail.zz_ay2627_staff_cleanup_log
    ADD CONSTRAINT pk_zz_ay2627_staff_cleanup_log PRIMARY KEY (workspace_id, run_id, step, table_name, row_id, action);


--
-- Name: zz_rds_release_log pk_zz_rds_release_log; Type: CONSTRAINT; Schema: audit_trail; Owner: -
--

ALTER TABLE ONLY audit_trail.zz_rds_release_log
    ADD CONSTRAINT pk_zz_rds_release_log PRIMARY KEY (workspace_id, run_id, step, table_name, row_id, action);


--
-- Name: zz_term_rename_c1_log pk_zz_term_rename_c1_log; Type: CONSTRAINT; Schema: audit_trail; Owner: -
--

ALTER TABLE ONLY audit_trail.zz_term_rename_c1_log
    ADD CONSTRAINT pk_zz_term_rename_c1_log PRIMARY KEY (workspace_id, run_id, phase_id);
...
--
-- Name: plan_composition_successor_legacy_backup plan_composition_successor_legacy_backup_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_composition_successor_legacy_backup
    ADD CONSTRAINT plan_composition_successor_legacy_backup_pkey PRIMARY KEY (plan_id);
...
--
-- Name: rating_description_set_entry rating_description_set_entry_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT rating_description_set_entry_pkey PRIMARY KEY (id);


--
-- Name: rating_description_set rating_description_set_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set
    ADD CONSTRAINT rating_description_set_pkey PRIMARY KEY (id);


--
-- Name: rating_description_set_product_plan rating_description_set_product_plan_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_product_plan
    ADD CONSTRAINT rating_description_set_product_plan_pkey PRIMARY KEY (id);
...
--
-- Name: template_task_criteria_rating_description template_task_criteria_rating_description_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria_rating_description
    ADD CONSTRAINT template_task_criteria_rating_description_pkey PRIMARY KEY (id);


--
-- Name: template_task_criteria_rating_description template_task_criteria_rating_description_unique_band; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria_rating_description
    ADD CONSTRAINT template_task_criteria_rating_description_unique_band UNIQUE (template_task_criteria_id, score_scale_band_id);
...
--
-- Name: rating_description_set_entry uq_rating_description_set_entry_set_criterion_band; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT uq_rating_description_set_entry_set_criterion_band UNIQUE (rating_description_set_id, outcome_criteria_id, score_scale_band_id);
...
--
-- Name: supplier_category uq_supplier_category_code; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_category
    ADD CONSTRAINT uq_supplier_category_code UNIQUE (code);
...
--
-- Name: zz_idremap_20260803 zz_idremap_20260803_new_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.zz_idremap_20260803
    ADD CONSTRAINT zz_idremap_20260803_new_id_key UNIQUE (new_id);


--
-- Name: zz_idremap_20260803 zz_idremap_20260803_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.zz_idremap_20260803
    ADD CONSTRAINT zz_idremap_20260803_pkey PRIMARY KEY (old_id);
...
--
-- Name: idx_activity_assigned_to; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activity_assigned_to ON public.activity USING btree (assigned_to);
...
--
-- Name: idx_activity_labor_activity_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activity_labor_activity_id ON public.activity_labor USING btree (activity_id);
...
--
-- Name: idx_client_workspace_user_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_workspace_user_workspace_user_id ON public.client_workspace_user USING btree (workspace_user_id);
...
--
-- Name: idx_conversation_client_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_conversation_post_sent_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_conversation_post_sent_at ON public.conversation_post USING btree (sent_at);
...
--
-- Name: idx_equity_transaction_transaction_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_equity_transaction_transaction_date ON public.equity_transaction USING btree (transaction_date);


--
-- Name: idx_evaluation_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_client_id ON public.evaluation USING btree (client_id);
...
--
-- Name: idx_evaluation_cycle_member_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_cycle_member_client_id ON public.evaluation_cycle_member USING btree (client_id);
...
--
-- Name: idx_evaluation_cycle_member_subject_staff_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_cycle_member_subject_staff_id ON public.evaluation_cycle_member USING btree (subject_staff_id);
...
--
-- Name: idx_evaluation_evaluator_client_portal_grant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_evaluator_client_portal_grant_id ON public.evaluation USING btree (evaluator_client_portal_grant_id) WHERE (evaluator_client_portal_grant_id IS NOT NULL);


--
-- Name: idx_evaluation_evaluator_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_evaluator_workspace_user_id ON public.evaluation USING btree (evaluator_workspace_user_id) WHERE (evaluator_workspace_user_id IS NOT NULL);
...
CREATE INDEX idx_evaluation_rating_xjoin ON public.evaluation USING btree (staff_id, status, submitted_at DESC, id DESC);
...
--
-- Name: idx_evaluation_response_outcome_criteria_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_response_outcome_criteria_id ON public.evaluation_response USING btree (outcome_criteria_id);
...
--
-- Name: idx_evaluation_subject_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_subject_client_id ON public.evaluation USING btree (subject_client_id) WHERE (subject_client_id IS NOT NULL);
...
--
-- Name: idx_evaluation_template_item_outcome_criteria_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_evaluation_template_item_outcome_criteria_id ON public.evaluation_template_item USING btree (outcome_criteria_id);
...
--
-- Name: idx_event_occurrence_workspace_end; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_event_occurrence_workspace_end ON public.event_occurrence USING btree (workspace_id, end_date_time_utc);
...
--
-- Name: idx_event_occurrence_workspace_start; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_event_occurrence_workspace_start ON public.event_occurrence USING btree (workspace_id, start_date_time_utc);
...
--
-- Name: idx_event_start_date_time_utc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_event_start_date_time_utc ON public.event USING btree (start_date_time_utc);
...
--
-- Name: idx_expenditure_workspace_type_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_expenditure_workspace_type_status ON public.expenditure USING btree (workspace_id, expenditure_type, status) WHERE (active = true);
...
--
-- Name: idx_job_origin_type_origin_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_origin_type_origin_id ON public.job USING btree (origin_type, origin_id);


--
-- Name: idx_job_outcome_line_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_line_client_id ON public.job_outcome_line USING btree (client_id) WHERE (client_id IS NOT NULL);


--
-- Name: idx_job_outcome_line_job_outcome_summary_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_line_job_outcome_summary_id ON public.job_outcome_line USING btree (job_outcome_summary_id);


--
-- Name: idx_job_outcome_line_score_scale_band_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_line_score_scale_band_id ON public.job_outcome_line USING btree (score_scale_band_id) WHERE (score_scale_band_id IS NOT NULL);


--
-- Name: idx_job_outcome_line_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_line_workspace_id ON public.job_outcome_line USING btree (workspace_id);


--
-- Name: idx_job_outcome_summary_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_summary_client_id ON public.job_outcome_summary USING btree (client_id) WHERE (client_id IS NOT NULL);
...
--
-- Name: idx_job_outcome_summary_scoring_scheme_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_summary_scoring_scheme_id ON public.job_outcome_summary USING btree (scoring_scheme_id) WHERE (scoring_scheme_id IS NOT NULL);
...
--
-- Name: idx_job_outcome_summary_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_outcome_summary_workspace_id ON public.job_outcome_summary USING btree (workspace_id);
...
--
-- Name: idx_job_template_phase_output_product_variant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_template_phase_output_product_variant_id ON public.job_template_phase USING btree (output_product_variant_id) WHERE (output_product_variant_id IS NOT NULL);
...
--
-- Name: idx_journal_entry_entry_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_journal_entry_entry_date ON public.journal_entry USING btree (entry_date);
...
--
-- Name: idx_line_workspace_user_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_line_workspace_user_workspace_id ON public.line_workspace_user USING btree (workspace_id);


--
-- Name: idx_line_workspace_user_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_line_workspace_user_workspace_user_id ON public.line_workspace_user USING btree (workspace_user_id);
...
--
-- Name: idx_loan_payment_payment_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_loan_payment_payment_date ON public.loan_payment USING btree (payment_date);
...
--
-- Name: idx_outcome_criteria_criteria_group_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_outcome_criteria_criteria_group_id ON public.outcome_criteria USING btree (criteria_group_id);
...
--
-- Name: idx_payroll_remittance_due_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payroll_remittance_due_date ON public.payroll_remittance USING btree (due_date);
...
--
-- Name: idx_payroll_run_pay_period_end; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payroll_run_pay_period_end ON public.payroll_run USING btree (pay_period_end);
...
--
-- Name: idx_phase_outcome_summary_reporting_checkpoint_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_phase_outcome_summary_reporting_checkpoint_id ON public.phase_outcome_summary USING btree (reporting_checkpoint_id) WHERE (reporting_checkpoint_id IS NOT NULL);
...
--
-- Name: idx_plan_group_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plan_group_parent_id ON public.plan_group USING btree (parent_id);


--
-- Name: idx_plan_group_plan_plan_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plan_group_plan_plan_id ON public.plan_group_plan USING btree (plan_id);


--
-- Name: idx_plan_group_plan_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plan_group_plan_workspace_id ON public.plan_group_plan USING btree (workspace_id);


--
-- Name: idx_plan_group_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plan_group_workspace_id ON public.plan_group USING btree (workspace_id);
...
--
-- Name: idx_price_schedule_workspace_user_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_price_schedule_workspace_user_workspace_id ON public.price_schedule_workspace_user USING btree (workspace_id);


--
-- Name: idx_price_schedule_workspace_user_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_price_schedule_workspace_user_workspace_user_id ON public.price_schedule_workspace_user USING btree (workspace_user_id);
...
--
-- Name: idx_product_plan_staff_staff_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_product_plan_staff_staff_id ON public.product_plan_staff USING btree (staff_id);


--
-- Name: idx_product_plan_staff_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_product_plan_staff_workspace_id ON public.product_plan_staff USING btree (workspace_id);
...
--
-- Name: idx_product_product_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_product_product_kind ON public.product USING btree (product_kind);
...
--
-- Name: idx_rate_table_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rate_table_kind ON public.rate_table USING btree (kind);
...
--
-- Name: idx_rate_table_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rate_table_status ON public.rate_table USING btree (status);
...
--
-- Name: idx_rating_description_set_entry_outcome_criteria_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_entry_outcome_criteria_id ON public.rating_description_set_entry USING btree (outcome_criteria_id);


--
-- Name: idx_rating_description_set_entry_rating_description_set_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_entry_rating_description_set_id ON public.rating_description_set_entry USING btree (rating_description_set_id);


--
-- Name: idx_rating_description_set_entry_score_scale_band_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_entry_score_scale_band_id ON public.rating_description_set_entry USING btree (score_scale_band_id);


--
-- Name: idx_rating_description_set_entry_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_entry_workspace_id ON public.rating_description_set_entry USING btree (workspace_id);


--
-- Name: idx_rating_description_set_product_plan_pair; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_product_plan_pair ON public.rating_description_set_product_plan USING btree (product_plan_id, price_schedule_id);


--
-- Name: idx_rating_description_set_product_plan_set_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_product_plan_set_id ON public.rating_description_set_product_plan USING btree (rating_description_set_id);


--
-- Name: idx_rating_description_set_product_plan_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_product_plan_workspace_id ON public.rating_description_set_product_plan USING btree (workspace_id);


--
-- Name: idx_rating_description_set_score_scale_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_score_scale_id ON public.rating_description_set USING btree (score_scale_id);


--
-- Name: idx_rating_description_set_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rating_description_set_workspace_id ON public.rating_description_set USING btree (workspace_id);


--
-- Name: idx_reporting_checkpoint_period_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reporting_checkpoint_period_id ON public.reporting_checkpoint USING btree (period_id) WHERE (period_id IS NOT NULL);


--
-- Name: idx_reporting_checkpoint_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reporting_checkpoint_workspace_id ON public.reporting_checkpoint USING btree (workspace_id) WHERE (workspace_id IS NOT NULL);
...
--
-- Name: idx_revenue_line_item_subscription_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_line_item_subscription_id ON public.revenue_line_item USING btree (subscription_id);
...
--
-- Name: idx_revenue_line_item_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_line_item_workspace_id ON public.revenue_line_item USING btree (workspace_id);


--
-- Name: idx_revenue_payment_collection_method_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_payment_collection_method_id ON public.revenue_payment USING btree (collection_method_id);


--
-- Name: idx_revenue_payment_revenue_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_payment_revenue_id ON public.revenue_payment USING btree (revenue_id);
...
--
-- Name: idx_revenue_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_workspace_id ON public.revenue USING btree (workspace_id) WHERE (workspace_id IS NOT NULL);
...
--
-- Name: idx_score_scale_band_score_scale_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_score_scale_band_score_scale_id ON public.score_scale_band USING btree (score_scale_id);


--
-- Name: idx_score_scale_band_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_score_scale_band_workspace_id ON public.score_scale_band USING btree (workspace_id) WHERE (workspace_id IS NOT NULL);
...
--
-- Name: idx_scoring_component_criteria_outcome_criteria_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_component_criteria_outcome_criteria_id ON public.scoring_component_criteria USING btree (outcome_criteria_id);


--
-- Name: idx_scoring_component_criteria_scoring_component_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_component_criteria_scoring_component_id ON public.scoring_component_criteria USING btree (scoring_component_id);


--
-- Name: idx_scoring_component_criteria_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_component_criteria_workspace_id ON public.scoring_component_criteria USING btree (workspace_id);


--
-- Name: idx_scoring_component_parent_component_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_component_parent_component_id ON public.scoring_component USING btree (parent_component_id) WHERE (parent_component_id IS NOT NULL);


--
-- Name: idx_scoring_component_scoring_scheme_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_component_scoring_scheme_id ON public.scoring_component USING btree (scoring_scheme_id);
...
--
-- Name: idx_scoring_scheme_score_scale_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scoring_scheme_score_scale_id ON public.scoring_scheme USING btree (score_scale_id) WHERE (score_scale_id IS NOT NULL);
...
--
-- Name: idx_subscription_group_member_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_member_client_id ON public.subscription_group_member USING btree (client_id);


--
-- Name: idx_subscription_group_member_subscription_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_member_subscription_id ON public.subscription_group_member USING btree (subscription_id);


--
-- Name: idx_subscription_group_member_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_member_workspace_id ON public.subscription_group_member USING btree (workspace_id);


--
-- Name: idx_subscription_group_plan_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_plan_id ON public.subscription_group USING btree (plan_id);


--
-- Name: idx_subscription_group_price_schedule_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_price_schedule_id ON public.subscription_group USING btree (price_schedule_id);
...
--
-- Name: idx_subscription_group_product_plan_staff_product_plan_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_product_plan_staff_product_plan_id ON public.subscription_group_product_plan_staff USING btree (product_plan_id);
...
--
-- Name: idx_subscription_group_product_plan_staff_staff_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_product_plan_staff_staff_id ON public.subscription_group_product_plan_staff USING btree (staff_id);
...
--
-- Name: idx_subscription_group_product_plan_staff_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_product_plan_staff_workspace_id ON public.subscription_group_product_plan_staff USING btree (workspace_id);
...
--
-- Name: idx_subscription_group_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_workspace_id ON public.subscription_group USING btree (workspace_id);


--
-- Name: idx_subscription_group_workspace_user_workspace_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_workspace_user_workspace_id ON public.subscription_group_workspace_user USING btree (workspace_id);


--
-- Name: idx_subscription_group_workspace_user_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_group_workspace_user_workspace_user_id ON public.subscription_group_workspace_user USING btree (workspace_user_id);
...
--
-- Name: idx_subscription_seat_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_seat_client_id ON public.subscription_seat USING btree (client_id);


--
-- Name: idx_subscription_seat_product_plan_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_seat_product_plan_id ON public.subscription_seat USING btree (product_plan_id);
...
--
-- Name: idx_subscription_workspace_user_workspace_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscription_workspace_user_workspace_user_id ON public.subscription_workspace_user USING btree (workspace_user_id);
...
--
-- Name: idx_supplier_category_category_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_supplier_category_category_id ON public.supplier_category USING btree (category_id);
...
--
-- Name: idx_supplier_lifecycle_event_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_supplier_lifecycle_event_category ON public.supplier_lifecycle_event USING btree (category);


--
-- Name: idx_supplier_lifecycle_event_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_supplier_lifecycle_event_kind ON public.supplier_lifecycle_event USING btree (kind);
...
--
-- Name: idx_tax_registration_party; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tax_registration_party ON public.tax_registration USING btree (party_type, party_id);
...
--
-- Name: idx_template_task_criteria_rating_description_band; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_template_task_criteria_rating_description_band ON public.template_task_criteria_rating_description USING btree (score_scale_band_id);


--
-- Name: idx_template_task_criteria_rating_description_ttc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_template_task_criteria_rating_description_ttc ON public.template_task_criteria_rating_description USING btree (template_task_criteria_id);


--
-- Name: idx_template_task_criteria_rating_description_workspace; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_template_task_criteria_rating_description_workspace ON public.template_task_criteria_rating_description USING btree (workspace_id) WHERE (workspace_id IS NOT NULL);
...
--
-- Name: idx_treasury_collection_revenue_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_treasury_collection_revenue_id ON public.treasury_collection USING btree (revenue_id);
...
--
-- Name: idx_treasury_disbursement_expenditure_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_treasury_disbursement_expenditure_id ON public.treasury_disbursement USING btree (expenditure_id);
...
CREATE UNIQUE INDEX uq_evaluation_associate_arc ON public.evaluation USING btree (client_id, staff_id, evaluation_type, evaluation_template_id, period_start) NULLS NOT DISTINCT WHERE (active AND (staff_id IS NOT NULL));
...
--
-- Name: uq_rating_description_set_product_plan_active_pair; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_rating_description_set_product_plan_active_pair ON public.rating_description_set_product_plan USING btree (product_plan_id, price_schedule_id) WHERE active;


--
-- Name: uq_rating_description_set_supersedes_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_rating_description_set_supersedes_id ON public.rating_description_set USING btree (supersedes_id) WHERE (supersedes_id IS NOT NULL);


--
-- Name: uq_rating_description_set_workspace_code_version; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_rating_description_set_workspace_code_version ON public.rating_description_set USING btree (workspace_id, code, version) WHERE (code IS NOT NULL);
...
--
-- Name: uq_tenant_subscription_active_per_workspace; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_tenant_subscription_active_per_workspace ON public.tenant_subscription USING btree (workspace_id) WHERE (status = ANY (ARRAY[1, 2, 3, 4]));
...
--
-- Name: account account_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.account
    ADD CONSTRAINT account_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.account_group(id);
...
--
-- Name: activity activity_activity_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity
    ADD CONSTRAINT activity_activity_template_id_fkey FOREIGN KEY (activity_template_id) REFERENCES public.activity_template(id);


--
-- Name: activity_execution_log activity_execution_log_activity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_execution_log
    ADD CONSTRAINT activity_execution_log_activity_id_fkey FOREIGN KEY (activity_id) REFERENCES public.activity(id);


--
-- Name: activity_execution_log activity_execution_log_activity_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_execution_log
    ADD CONSTRAINT activity_execution_log_activity_template_id_fkey FOREIGN KEY (activity_template_id) REFERENCES public.activity_template(id);


--
-- Name: activity_execution_log activity_execution_log_workflow_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_execution_log
    ADD CONSTRAINT activity_execution_log_workflow_id_fkey FOREIGN KEY (workflow_id) REFERENCES public.workflow(id);


--
-- Name: activity_execution_log activity_execution_log_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_execution_log
    ADD CONSTRAINT activity_execution_log_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: activity activity_stage_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity
    ADD CONSTRAINT activity_stage_id_fkey FOREIGN KEY (stage_id) REFERENCES public.stage(id);


--
-- Name: activity_template activity_template_stage_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_template
    ADD CONSTRAINT activity_template_stage_template_id_fkey FOREIGN KEY (stage_template_id) REFERENCES public.stage_template(id);
...
--
-- Name: asset_category asset_category_parent_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_category
    ADD CONSTRAINT asset_category_parent_category_id_fkey FOREIGN KEY (parent_category_id) REFERENCES public.asset_category(id);
...
--
-- Name: asset_component asset_component_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_component
    ADD CONSTRAINT asset_component_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);


--
-- Name: asset_disposal asset_disposal_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_disposal
    ADD CONSTRAINT asset_disposal_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);


--
-- Name: asset_location asset_location_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_location
    ADD CONSTRAINT asset_location_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);
...
ALTER TABLE ONLY public.asset
    ADD CONSTRAINT asset_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: asset_location asset_location_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_location
    ADD CONSTRAINT asset_location_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);
...
ALTER TABLE ONLY public.asset_maintenance
    ADD CONSTRAINT asset_maintenance_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);


--
-- Name: asset_revaluation asset_revaluation_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_revaluation
    ADD CONSTRAINT asset_revaluation_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);


--
-- Name: asset_transaction asset_transaction_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_transaction
    ADD CONSTRAINT asset_transaction_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);
...
--
-- Name: attribute_value attribute_value_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_value
    ADD CONSTRAINT attribute_value_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: balance_attribute balance_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.balance_attribute
    ADD CONSTRAINT balance_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: balance_attribute balance_attribute_balance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.balance_attribute
    ADD CONSTRAINT balance_attribute_balance_id_fkey FOREIGN KEY (balance_id) REFERENCES public.balance(id);


--
-- Name: balance balance_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance balance_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.balance
    ADD CONSTRAINT balance_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscription(id);
...
--
-- Name: client_attribute client_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_attribute
    ADD CONSTRAINT client_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: client_attribute client_attribute_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_attribute
    ADD CONSTRAINT client_attribute_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: client_category client_category_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_category
    ADD CONSTRAINT client_category_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.category(id);


--
-- Name: client_category client_category_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_category
    ADD CONSTRAINT client_category_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: client client_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client
    ADD CONSTRAINT client_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.client_category(id);
...
ALTER TABLE ONLY public.client
    ADD CONSTRAINT client_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);
...
--
-- Name: conversation conversation_assigned_to_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT conversation_assigned_to_user_id_fkey FOREIGN KEY (assigned_to_user_id) REFERENCES public."user"(id);


--
-- Name: conversation conversation_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT conversation_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: conversation conversation_created_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT conversation_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public."user"(id);
...
ALTER TABLE ONLY public.conversation_participant
    ADD CONSTRAINT conversation_participant_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);


--
-- Name: conversation_post conversation_post_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation_post
    ADD CONSTRAINT conversation_post_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);
...
--
-- Name: conversation_post conversation_post_sender_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation_post
    ADD CONSTRAINT conversation_post_sender_user_id_fkey FOREIGN KEY (sender_user_id) REFERENCES public."user"(id);
...
--
-- Name: conversation_read_receipt conversation_read_receipt_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation_read_receipt
    ADD CONSTRAINT conversation_read_receipt_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);


--
-- Name: conversation conversation_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT conversation_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: delegate_attribute delegate_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegate_attribute
    ADD CONSTRAINT delegate_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: delegate_attribute delegate_attribute_delegate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegate_attribute
    ADD CONSTRAINT delegate_attribute_delegate_id_fkey FOREIGN KEY (delegate_id) REFERENCES public.delegate(id);


--
-- Name: delegate_client delegate_client_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegate_client
    ADD CONSTRAINT delegate_client_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: delegate_client delegate_client_delegate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegate_client
    ADD CONSTRAINT delegate_client_delegate_id_fkey FOREIGN KEY (delegate_id) REFERENCES public.delegate(id);
...
--
-- Name: delegate delegate_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegate
    ADD CONSTRAINT delegate_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);
...
--
-- Name: depreciation_schedule depreciation_schedule_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.depreciation_schedule
    ADD CONSTRAINT depreciation_schedule_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.asset(id);
...
--
-- Name: equity_account equity_account_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equity_account
    ADD CONSTRAINT equity_account_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account(id);
...
--
-- Name: equity_transaction equity_transaction_equity_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equity_transaction
    ADD CONSTRAINT equity_transaction_equity_account_id_fkey FOREIGN KEY (equity_account_id) REFERENCES public.equity_account(id);


--
-- Name: equity_transaction equity_transaction_journal_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equity_transaction
    ADD CONSTRAINT equity_transaction_journal_entry_id_fkey FOREIGN KEY (journal_entry_id) REFERENCES public.journal_entry(id);
...
ALTER TABLE ONLY public.evaluation
    ADD CONSTRAINT evaluation_subject_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
--
-- Name: event_attendee event_attendee_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_attendee
    ADD CONSTRAINT event_attendee_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);
...
ALTER TABLE ONLY public.event_attendee
    ADD CONSTRAINT event_attendee_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_attendee event_attendee_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_attendee
    ADD CONSTRAINT event_attendee_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event_attendee event_attendee_workspace_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_attendee
    ADD CONSTRAINT event_attendee_workspace_user_id_fkey FOREIGN KEY (workspace_user_id) REFERENCES public.workspace_user(id);


--
-- Name: event_attribute event_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_attribute
    ADD CONSTRAINT event_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: event_attribute event_attribute_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_attribute
    ADD CONSTRAINT event_attribute_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_client event_client_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_client
    ADD CONSTRAINT event_client_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: event_client event_client_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_client
    ADD CONSTRAINT event_client_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event event_event_recurrence_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_event_recurrence_id_fkey FOREIGN KEY (event_recurrence_id) REFERENCES public.event_recurrence(id);
...
--
-- Name: event_occurrence event_occurrence_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_occurrence
    ADD CONSTRAINT event_occurrence_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_occurrence event_occurrence_exception_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_occurrence
    ADD CONSTRAINT event_occurrence_exception_event_id_fkey FOREIGN KEY (exception_event_id) REFERENCES public.event(id);


--
-- Name: event_occurrence event_occurrence_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_occurrence
    ADD CONSTRAINT event_occurrence_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event event_organizer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_organizer_id_fkey FOREIGN KEY (organizer_id) REFERENCES public.workspace_user(id);
...
ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_parent_event_id_fkey FOREIGN KEY (parent_event_id) REFERENCES public.event(id);


--
-- Name: event_product event_product_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_product
    ADD CONSTRAINT event_product_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_product event_product_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_product
    ADD CONSTRAINT event_product_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: event_recurrence event_recurrence_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_recurrence
    ADD CONSTRAINT event_recurrence_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event_resource event_resource_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_resource
    ADD CONSTRAINT event_resource_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_resource event_resource_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_resource
    ADD CONSTRAINT event_resource_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event_tag_assignment event_tag_assignment_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_tag_assignment
    ADD CONSTRAINT event_tag_assignment_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id);


--
-- Name: event_tag_assignment event_tag_assignment_event_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_tag_assignment
    ADD CONSTRAINT event_tag_assignment_event_tag_id_fkey FOREIGN KEY (event_tag_id) REFERENCES public.event_tag(id);


--
-- Name: event_tag_assignment event_tag_assignment_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_tag_assignment
    ADD CONSTRAINT event_tag_assignment_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event_tag event_tag_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_tag
    ADD CONSTRAINT event_tag_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: event event_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: expenditure_line_item expenditure_line_item_inventory_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditure_line_item
    ADD CONSTRAINT expenditure_line_item_inventory_item_id_fkey FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);


--
-- Name: expenditure_line_item expenditure_line_item_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditure_line_item
    ADD CONSTRAINT expenditure_line_item_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: expenditure_line_item expenditure_line_item_purchase_order_line_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditure_line_item
    ADD CONSTRAINT expenditure_line_item_purchase_order_line_item_id_fkey FOREIGN KEY (purchase_order_line_item_id) REFERENCES public.purchase_order_line_item(id);
...
--
-- Name: expenditure expenditure_purchase_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditure
    ADD CONSTRAINT expenditure_purchase_order_id_fkey FOREIGN KEY (purchase_order_id) REFERENCES public.purchase_order(id);
...
--
-- Name: expenditure expenditure_supplier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditure
    ADD CONSTRAINT expenditure_supplier_id_fkey FOREIGN KEY (supplier_id) REFERENCES public.supplier(id);
...
--
-- Name: expense_recognition expense_recognition_accrued_expense_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expense_recognition
    ADD CONSTRAINT expense_recognition_accrued_expense_id_fkey FOREIGN KEY (accrued_expense_id) REFERENCES public.accrued_expense(id);
...
--
-- Name: activity_expense fk_activity_expense_activity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_expense
    ADD CONSTRAINT fk_activity_expense_activity_id FOREIGN KEY (activity_id) REFERENCES public.job_activity(id);


--
-- Name: activity_expense fk_activity_expense_expense_category_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_expense
    ADD CONSTRAINT fk_activity_expense_expense_category_id FOREIGN KEY (expense_category_id) REFERENCES public.expenditure_category(id);


--
-- Name: activity_labor fk_activity_labor_activity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_labor
    ADD CONSTRAINT fk_activity_labor_activity_id FOREIGN KEY (activity_id) REFERENCES public.job_activity(id);


--
-- Name: activity_labor fk_activity_labor_staff_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_labor
    ADD CONSTRAINT fk_activity_labor_staff_id FOREIGN KEY (staff_id) REFERENCES public.staff(id);


--
-- Name: activity_material fk_activity_material_activity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_material
    ADD CONSTRAINT fk_activity_material_activity_id FOREIGN KEY (activity_id) REFERENCES public.job_activity(id);


--
-- Name: activity_material fk_activity_material_location_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_material
    ADD CONSTRAINT fk_activity_material_location_id FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: activity_material fk_activity_material_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_material
    ADD CONSTRAINT fk_activity_material_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: collection_attribute fk_collection_attribute_attribute_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_attribute
    ADD CONSTRAINT fk_collection_attribute_attribute_id FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: collection_attribute fk_collection_attribute_collection_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_attribute
    ADD CONSTRAINT fk_collection_attribute_collection_id FOREIGN KEY (collection_id) REFERENCES public.collection(id);


--
-- Name: collection_parent fk_collection_parent_collection_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_parent
    ADD CONSTRAINT fk_collection_parent_collection_id FOREIGN KEY (collection_id) REFERENCES public.collection(id);


--
-- Name: collection_parent fk_collection_parent_collection_parent_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_parent
    ADD CONSTRAINT fk_collection_parent_collection_parent_id FOREIGN KEY (collection_parent_id) REFERENCES public.collection(id);


--
-- Name: collection_plan fk_collection_plan_collection_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_plan
    ADD CONSTRAINT fk_collection_plan_collection_id FOREIGN KEY (collection_id) REFERENCES public.collection(id);


--
-- Name: collection_plan fk_collection_plan_plan_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.collection_plan
    ADD CONSTRAINT fk_collection_plan_plan_id FOREIGN KEY (plan_id) REFERENCES public.plan(id);


--
-- Name: criteria_option fk_criteria_option_outcome_criteria_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.criteria_option
    ADD CONSTRAINT fk_criteria_option_outcome_criteria_id FOREIGN KEY (outcome_criteria_id) REFERENCES public.outcome_criteria(id);


--
-- Name: criteria_threshold fk_criteria_threshold_outcome_criteria_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.criteria_threshold
    ADD CONSTRAINT fk_criteria_threshold_outcome_criteria_id FOREIGN KEY (outcome_criteria_id) REFERENCES public.outcome_criteria(id);


--
-- Name: inventory_movement fk_inventory_movement_from_location_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_from_location_id FOREIGN KEY (from_location_id) REFERENCES public.location(id);


--
-- Name: inventory_movement fk_inventory_movement_inventory_item_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_inventory_item_id FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);


--
-- Name: inventory_movement fk_inventory_movement_inventory_serial_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_inventory_serial_id FOREIGN KEY (inventory_serial_id) REFERENCES public.inventory_serial(id);


--
-- Name: inventory_movement fk_inventory_movement_job_activity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_job_activity_id FOREIGN KEY (job_activity_id) REFERENCES public.job_activity(id);


--
-- Name: inventory_movement fk_inventory_movement_job_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_job_id FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: inventory_movement fk_inventory_movement_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: inventory_movement fk_inventory_movement_to_location_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_to_location_id FOREIGN KEY (to_location_id) REFERENCES public.location(id);


--
-- Name: inventory_movement fk_inventory_movement_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_movement
    ADD CONSTRAINT fk_inventory_movement_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: job_activity fk_job_activity_job_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_activity
    ADD CONSTRAINT fk_job_activity_job_id FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: job_activity fk_job_activity_job_task_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_activity
    ADD CONSTRAINT fk_job_activity_job_task_id FOREIGN KEY (job_task_id) REFERENCES public.job_task(id);


--
-- Name: job_activity fk_job_activity_resource_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_activity
    ADD CONSTRAINT fk_job_activity_resource_id FOREIGN KEY (resource_id) REFERENCES public.resource(id);


--
-- Name: job_activity fk_job_activity_reversal_of_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_activity
    ADD CONSTRAINT fk_job_activity_reversal_of_id FOREIGN KEY (reversal_of_id) REFERENCES public.job_activity(id);


--
-- Name: job_activity fk_job_activity_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_activity
    ADD CONSTRAINT fk_job_activity_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: job fk_job_client_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job
    ADD CONSTRAINT fk_job_client_id FOREIGN KEY (client_id) REFERENCES public.client(id);
...
--
-- Name: job fk_job_job_template_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job
    ADD CONSTRAINT fk_job_job_template_id FOREIGN KEY (job_template_id) REFERENCES public.job_template(id);


--
-- Name: job fk_job_location_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job
    ADD CONSTRAINT fk_job_location_id FOREIGN KEY (location_id) REFERENCES public.location(id);
...
--
-- Name: job_outcome_summary fk_job_outcome_summary_client_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_client_id FOREIGN KEY (client_id) REFERENCES public.client(id);


--
-- Name: job_outcome_summary fk_job_outcome_summary_issued_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_issued_by FOREIGN KEY (issued_by) REFERENCES public.staff(id);


--
-- Name: job_outcome_summary fk_job_outcome_summary_job_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_job_id FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: job_outcome_summary fk_job_outcome_summary_scoring_scheme_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_scoring_scheme_id FOREIGN KEY (scoring_scheme_id) REFERENCES public.scoring_scheme(id);


--
-- Name: job_outcome_summary fk_job_outcome_summary_supersedes_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_supersedes_id FOREIGN KEY (supersedes_id) REFERENCES public.job_outcome_summary(id);


--
-- Name: job_outcome_summary fk_job_outcome_summary_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_outcome_summary
    ADD CONSTRAINT fk_job_outcome_summary_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: job_phase fk_job_phase_job_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_phase
    ADD CONSTRAINT fk_job_phase_job_id FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: job_phase fk_job_phase_scoring_scheme_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_phase
    ADD CONSTRAINT fk_job_phase_scoring_scheme_id FOREIGN KEY (scoring_scheme_id) REFERENCES public.scoring_scheme(id);


--
-- Name: job_settlement fk_job_settlement_job_activity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_settlement
    ADD CONSTRAINT fk_job_settlement_job_activity_id FOREIGN KEY (job_activity_id) REFERENCES public.job_activity(id);


--
-- Name: job_settlement fk_job_settlement_reversal_of_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_settlement
    ADD CONSTRAINT fk_job_settlement_reversal_of_id FOREIGN KEY (reversal_of_id) REFERENCES public.job_settlement(id);


--
-- Name: job_settlement fk_job_settlement_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_settlement
    ADD CONSTRAINT fk_job_settlement_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: job_task fk_job_task_assigned_to; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_task
    ADD CONSTRAINT fk_job_task_assigned_to FOREIGN KEY (assigned_to) REFERENCES public.staff(id);


--
-- Name: job_task fk_job_task_job_phase_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_task
    ADD CONSTRAINT fk_job_task_job_phase_id FOREIGN KEY (job_phase_id) REFERENCES public.job_phase(id);
...
--
-- Name: job_template_phase fk_job_template_phase_job_template_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_template_phase
    ADD CONSTRAINT fk_job_template_phase_job_template_id FOREIGN KEY (job_template_id) REFERENCES public.job_template(id);


--
-- Name: job_template_phase fk_job_template_phase_output_product_variant_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_template_phase
    ADD CONSTRAINT fk_job_template_phase_output_product_variant_id FOREIGN KEY (output_product_variant_id) REFERENCES public.product_variant(id);


--
-- Name: job_template_phase fk_job_template_phase_scoring_scheme_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_template_phase
    ADD CONSTRAINT fk_job_template_phase_scoring_scheme_id FOREIGN KEY (scoring_scheme_id) REFERENCES public.scoring_scheme(id);


--
-- Name: job_template_task fk_job_template_task_job_template_phase_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_template_task
    ADD CONSTRAINT fk_job_template_task_job_template_phase_id FOREIGN KEY (job_template_phase_id) REFERENCES public.job_template_phase(id);


--
-- Name: job_template fk_job_template_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_template
    ADD CONSTRAINT fk_job_template_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: job fk_job_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job
    ADD CONSTRAINT fk_job_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: outcome_criteria fk_outcome_criteria_overrides_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outcome_criteria
    ADD CONSTRAINT fk_outcome_criteria_overrides_id FOREIGN KEY (overrides_id) REFERENCES public.outcome_criteria(id);


--
-- Name: outcome_criteria fk_outcome_criteria_supersedes_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outcome_criteria
    ADD CONSTRAINT fk_outcome_criteria_supersedes_id FOREIGN KEY (supersedes_id) REFERENCES public.outcome_criteria(id);


--
-- Name: outcome_criteria fk_outcome_criteria_workspace_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outcome_criteria
    ADD CONSTRAINT fk_outcome_criteria_workspace_id FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: phase_outcome_summary fk_phase_outcome_summary_issued_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phase_outcome_summary
    ADD CONSTRAINT fk_phase_outcome_summary_issued_by FOREIGN KEY (issued_by) REFERENCES public.staff(id);


--
-- Name: phase_outcome_summary fk_phase_outcome_summary_job_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phase_outcome_summary
    ADD CONSTRAINT fk_phase_outcome_summary_job_id FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: phase_outcome_summary fk_phase_outcome_summary_job_phase_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phase_outcome_summary
    ADD CONSTRAINT fk_phase_outcome_summary_job_phase_id FOREIGN KEY (job_phase_id) REFERENCES public.job_phase(id);


--
-- Name: phase_outcome_summary fk_phase_outcome_summary_reporting_checkpoint_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phase_outcome_summary
    ADD CONSTRAINT fk_phase_outcome_summary_reporting_checkpoint_id FOREIGN KEY (reporting_checkpoint_id) REFERENCES public.reporting_checkpoint(id);


--
-- Name: phase_outcome_summary fk_phase_outcome_summary_supersedes_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phase_outcome_summary
    ADD CONSTRAINT fk_phase_outcome_summary_supersedes_id FOREIGN KEY (supersedes_id) REFERENCES public.phase_outcome_summary(id);
...
--
-- Name: price_list fk_price_list_location_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_list
    ADD CONSTRAINT fk_price_list_location_id FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: price_product fk_price_product_price_list_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_product
    ADD CONSTRAINT fk_price_product_price_list_id FOREIGN KEY (price_list_id) REFERENCES public.price_list(id);


--
-- Name: price_product fk_price_product_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_product
    ADD CONSTRAINT fk_price_product_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);
...
--
-- Name: product_attribute fk_product_attribute_attribute_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_attribute
    ADD CONSTRAINT fk_product_attribute_attribute_id FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: product_attribute fk_product_attribute_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_attribute
    ADD CONSTRAINT fk_product_attribute_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: product_collection fk_product_collection_collection_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_collection
    ADD CONSTRAINT fk_product_collection_collection_id FOREIGN KEY (collection_id) REFERENCES public.collection(id);


--
-- Name: product_collection fk_product_collection_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_collection
    ADD CONSTRAINT fk_product_collection_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: product_line fk_product_line_line_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_line
    ADD CONSTRAINT fk_product_line_line_id FOREIGN KEY (line_id) REFERENCES public.line(id);


--
-- Name: product_line fk_product_line_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_line
    ADD CONSTRAINT fk_product_line_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: product_option fk_product_option_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_option
    ADD CONSTRAINT fk_product_option_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: product_option_value fk_product_option_value_product_option_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_option_value
    ADD CONSTRAINT fk_product_option_value_product_option_id FOREIGN KEY (product_option_id) REFERENCES public.product_option(id);


--
-- Name: product_plan fk_product_plan_plan_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_plan
    ADD CONSTRAINT fk_product_plan_plan_id FOREIGN KEY (plan_id) REFERENCES public.plan(id);


--
-- Name: product_plan fk_product_plan_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_plan
    ADD CONSTRAINT fk_product_plan_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: product_plan fk_product_plan_product_variant_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_plan
    ADD CONSTRAINT fk_product_plan_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES public.product_variant(id);
...
--
-- Name: product_variant_image fk_product_variant_image_product_variant_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variant_image
    ADD CONSTRAINT fk_product_variant_image_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES public.product_variant(id);


--
-- Name: product_variant_option fk_product_variant_option_product_option_value_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variant_option
    ADD CONSTRAINT fk_product_variant_option_product_option_value_id FOREIGN KEY (product_option_value_id) REFERENCES public.product_option_value(id);


--
-- Name: product_variant_option fk_product_variant_option_product_variant_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variant_option
    ADD CONSTRAINT fk_product_variant_option_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES public.product_variant(id);


--
-- Name: product_variant fk_product_variant_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variant
    ADD CONSTRAINT fk_product_variant_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);
...
--
-- Name: resource fk_resource_product_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resource
    ADD CONSTRAINT fk_resource_product_id FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: resource fk_resource_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resource
    ADD CONSTRAINT fk_resource_user_id FOREIGN KEY (user_id) REFERENCES public."user"(id);
...
--
-- Name: task_outcome_check fk_task_outcome_check_criteria_option_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome_check
    ADD CONSTRAINT fk_task_outcome_check_criteria_option_id FOREIGN KEY (criteria_option_id) REFERENCES public.criteria_option(id);


--
-- Name: task_outcome_check fk_task_outcome_check_task_outcome_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome_check
    ADD CONSTRAINT fk_task_outcome_check_task_outcome_id FOREIGN KEY (task_outcome_id) REFERENCES public.task_outcome(id);


--
-- Name: task_outcome fk_task_outcome_criteria_version_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome
    ADD CONSTRAINT fk_task_outcome_criteria_version_id FOREIGN KEY (criteria_version_id) REFERENCES public.outcome_criteria(id);


--
-- Name: task_outcome fk_task_outcome_job_task_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome
    ADD CONSTRAINT fk_task_outcome_job_task_id FOREIGN KEY (job_task_id) REFERENCES public.job_task(id);


--
-- Name: task_outcome fk_task_outcome_recorded_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome
    ADD CONSTRAINT fk_task_outcome_recorded_by FOREIGN KEY (recorded_by) REFERENCES public.staff(id);


--
-- Name: task_outcome fk_task_outcome_reviewed_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome
    ADD CONSTRAINT fk_task_outcome_reviewed_by FOREIGN KEY (reviewed_by) REFERENCES public.staff(id);


--
-- Name: task_outcome fk_task_outcome_revision_of_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_outcome
    ADD CONSTRAINT fk_task_outcome_revision_of_id FOREIGN KEY (revision_of_id) REFERENCES public.task_outcome(id);


--
-- Name: template_task_criteria fk_template_task_criteria_job_template_task_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria
    ADD CONSTRAINT fk_template_task_criteria_job_template_task_id FOREIGN KEY (job_template_task_id) REFERENCES public.job_template_task(id);


--
-- Name: template_task_criteria fk_template_task_criteria_outcome_criteria_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria
    ADD CONSTRAINT fk_template_task_criteria_outcome_criteria_id FOREIGN KEY (outcome_criteria_id) REFERENCES public.outcome_criteria(id);
...
--
-- Name: fulfillment fulfillment_expenditure_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment
    ADD CONSTRAINT fulfillment_expenditure_id_fkey FOREIGN KEY (expenditure_id) REFERENCES public.expenditure(id);


--
-- Name: fulfillment_item fulfillment_item_fulfillment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_item
    ADD CONSTRAINT fulfillment_item_fulfillment_id_fkey FOREIGN KEY (fulfillment_id) REFERENCES public.fulfillment(id);


--
-- Name: fulfillment_item fulfillment_item_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_item
    ADD CONSTRAINT fulfillment_item_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: fulfillment_item fulfillment_item_revenue_line_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_item
    ADD CONSTRAINT fulfillment_item_revenue_line_item_id_fkey FOREIGN KEY (revenue_line_item_id) REFERENCES public.revenue_line_item(id);


--
-- Name: fulfillment_return fulfillment_return_fulfillment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_return
    ADD CONSTRAINT fulfillment_return_fulfillment_id_fkey FOREIGN KEY (fulfillment_id) REFERENCES public.fulfillment(id);


--
-- Name: fulfillment_return_item fulfillment_return_item_fulfillment_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_return_item
    ADD CONSTRAINT fulfillment_return_item_fulfillment_item_id_fkey FOREIGN KEY (fulfillment_item_id) REFERENCES public.fulfillment_item(id);


--
-- Name: fulfillment_return_item fulfillment_return_item_fulfillment_return_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_return_item
    ADD CONSTRAINT fulfillment_return_item_fulfillment_return_id_fkey FOREIGN KEY (fulfillment_return_id) REFERENCES public.fulfillment_return(id);


--
-- Name: fulfillment fulfillment_revenue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment
    ADD CONSTRAINT fulfillment_revenue_id_fkey FOREIGN KEY (revenue_id) REFERENCES public.revenue(id);


--
-- Name: fulfillment_status_event fulfillment_status_event_fulfillment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment_status_event
    ADD CONSTRAINT fulfillment_status_event_fulfillment_id_fkey FOREIGN KEY (fulfillment_id) REFERENCES public.fulfillment(id);


--
-- Name: fulfillment fulfillment_supplier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fulfillment
    ADD CONSTRAINT fulfillment_supplier_id_fkey FOREIGN KEY (supplier_id) REFERENCES public.supplier(id);
...
--
-- Name: fund_transaction fund_transaction_disbursement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_transaction
    ADD CONSTRAINT fund_transaction_disbursement_id_fkey FOREIGN KEY (disbursement_id) REFERENCES public.treasury_disbursement(id);
...
--
-- Name: group_attribute group_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.group_attribute
    ADD CONSTRAINT group_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: group_attribute group_attribute_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.group_attribute
    ADD CONSTRAINT group_attribute_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."group"(id);
...
--
-- Name: inventory_depreciation inventory_depreciation_inventory_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_depreciation
    ADD CONSTRAINT inventory_depreciation_inventory_item_id_fkey FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);
...
--
-- Name: inventory_serial_history inventory_serial_history_inventory_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_serial_history
    ADD CONSTRAINT inventory_serial_history_inventory_item_id_fkey FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);


--
-- Name: inventory_serial_history inventory_serial_history_inventory_serial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_serial_history
    ADD CONSTRAINT inventory_serial_history_inventory_serial_id_fkey FOREIGN KEY (inventory_serial_id) REFERENCES public.inventory_serial(id);
...
--
-- Name: inventory_serial inventory_serial_inventory_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_serial
    ADD CONSTRAINT inventory_serial_inventory_item_id_fkey FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);
...
--
-- Name: invoice_attribute invoice_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoice_attribute
    ADD CONSTRAINT invoice_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: invoice_attribute invoice_attribute_invoice_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoice_attribute
    ADD CONSTRAINT invoice_attribute_invoice_id_fkey FOREIGN KEY (invoice_id) REFERENCES public.invoice(id);
...
--
-- Name: journal_entry journal_entry_reversal_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.journal_entry
    ADD CONSTRAINT journal_entry_reversal_entry_id_fkey FOREIGN KEY (reversal_entry_id) REFERENCES public.journal_entry(id);
...
--
-- Name: license_history license_history_license_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: license license_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.license
    ADD CONSTRAINT license_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plan(id);


--
-- Name: license license_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.license
    ADD CONSTRAINT license_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscription(id);
...
--
-- Name: loan loan_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loan
    ADD CONSTRAINT loan_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account(id);


--
-- Name: loan_payment loan_payment_loan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loan_payment
    ADD CONSTRAINT loan_payment_loan_id_fkey FOREIGN KEY (loan_id) REFERENCES public.loan(id);


--
-- Name: location_area location_area_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.location_area
    ADD CONSTRAINT location_area_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: location_attribute location_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.location_attribute
    ADD CONSTRAINT location_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: location_attribute location_attribute_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.location_attribute
    ADD CONSTRAINT location_attribute_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: location location_location_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.location
    ADD CONSTRAINT location_location_area_id_fkey FOREIGN KEY (location_area_id) REFERENCES public.location_area(id);


--
-- Name: location location_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.location
    ADD CONSTRAINT location_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: payment_term payment_term_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payment_term
    ADD CONSTRAINT payment_term_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: payroll_remittance payroll_remittance_payroll_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_remittance
    ADD CONSTRAINT payroll_remittance_payroll_run_id_fkey FOREIGN KEY (payroll_run_id) REFERENCES public.payroll_run(id);
...
--
-- Name: permission permission_granted_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.permission
    ADD CONSTRAINT permission_granted_by_user_id_fkey FOREIGN KEY (granted_by_user_id) REFERENCES public."user"(id);


--
-- Name: permission permission_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: permission permission_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.permission
    ADD CONSTRAINT permission_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: petty_cash_fund petty_cash_fund_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.petty_cash_fund
    ADD CONSTRAINT petty_cash_fund_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: petty_cash_replenishment petty_cash_replenishment_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.petty_cash_replenishment
    ADD CONSTRAINT petty_cash_replenishment_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.petty_cash_fund(id);


--
-- Name: petty_cash_voucher petty_cash_voucher_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.petty_cash_voucher
    ADD CONSTRAINT petty_cash_voucher_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.petty_cash_fund(id);
...
--
-- Name: plan_attribute plan_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_attribute
    ADD CONSTRAINT plan_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: plan_attribute plan_attribute_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_attribute
    ADD CONSTRAINT plan_attribute_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plan(id);
...
--
-- Name: plan_location plan_location_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_location
    ADD CONSTRAINT plan_location_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: plan_location plan_location_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_location
    ADD CONSTRAINT plan_location_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plan(id);
...
--
-- Name: plan_settings plan_settings_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_settings
    ADD CONSTRAINT plan_settings_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plan(id);
...
--
-- Name: price_plan price_plan_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_plan
    ADD CONSTRAINT price_plan_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plan(id);


--
-- Name: price_plan price_plan_price_schedule_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_plan
    ADD CONSTRAINT price_plan_price_schedule_id_fkey FOREIGN KEY (price_schedule_id) REFERENCES public.price_schedule(id);
...
--
-- Name: price_schedule price_schedule_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_schedule
    ADD CONSTRAINT price_schedule_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);
...
--
-- Name: product product_line_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT product_line_id_fkey FOREIGN KEY (line_id) REFERENCES public.line(id);
...
--
-- Name: product_price_plan product_price_plan_price_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_price_plan
    ADD CONSTRAINT product_price_plan_price_plan_id_fkey FOREIGN KEY (price_plan_id) REFERENCES public.price_plan(id);


--
-- Name: product_price_plan product_price_plan_product_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_price_plan
    ADD CONSTRAINT product_price_plan_product_plan_id_fkey FOREIGN KEY (product_plan_id) REFERENCES public.product_plan(id);
...
--
-- Name: purchase_order_line_item purchase_order_line_item_inventory_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order_line_item
    ADD CONSTRAINT purchase_order_line_item_inventory_item_id_fkey FOREIGN KEY (inventory_item_id) REFERENCES public.inventory_item(id);


--
-- Name: purchase_order_line_item purchase_order_line_item_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order_line_item
    ADD CONSTRAINT purchase_order_line_item_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: purchase_order_line_item purchase_order_line_item_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order_line_item
    ADD CONSTRAINT purchase_order_line_item_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id);


--
-- Name: purchase_order_line_item purchase_order_line_item_purchase_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order_line_item
    ADD CONSTRAINT purchase_order_line_item_purchase_order_id_fkey FOREIGN KEY (purchase_order_id) REFERENCES public.purchase_order(id);


--
-- Name: purchase_order purchase_order_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order
    ADD CONSTRAINT purchase_order_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.location(id);


--
-- Name: purchase_order purchase_order_parent_po_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order
    ADD CONSTRAINT purchase_order_parent_po_id_fkey FOREIGN KEY (parent_po_id) REFERENCES public.purchase_order(id);


--
-- Name: purchase_order purchase_order_payment_term_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_order
    ADD CONSTRAINT purchase_order_payment_term_id_fkey FOREIGN KEY (payment_term_id) REFERENCES public.payment_term(id);
...
--
-- Name: rating_description_set_entry rating_description_set_entry_outcome_criteria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT rating_description_set_entry_outcome_criteria_id_fkey FOREIGN KEY (outcome_criteria_id) REFERENCES public.outcome_criteria(id);


--
-- Name: rating_description_set_entry rating_description_set_entry_rating_description_set_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT rating_description_set_entry_rating_description_set_id_fkey FOREIGN KEY (rating_description_set_id) REFERENCES public.rating_description_set(id);


--
-- Name: rating_description_set_entry rating_description_set_entry_score_scale_band_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT rating_description_set_entry_score_scale_band_id_fkey FOREIGN KEY (score_scale_band_id) REFERENCES public.score_scale_band(id);


--
-- Name: rating_description_set_entry rating_description_set_entry_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_entry
    ADD CONSTRAINT rating_description_set_entry_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: rating_description_set_product_plan rating_description_set_product_plan_price_schedule_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_product_plan
    ADD CONSTRAINT rating_description_set_product_plan_price_schedule_id_fkey FOREIGN KEY (price_schedule_id) REFERENCES public.price_schedule(id);


--
-- Name: rating_description_set_product_plan rating_description_set_product_plan_product_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_product_plan
    ADD CONSTRAINT rating_description_set_product_plan_product_plan_id_fkey FOREIGN KEY (product_plan_id) REFERENCES public.product_plan(id);


--
-- Name: rating_description_set_product_plan rating_description_set_product_plan_rating_description_set_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_product_plan
    ADD CONSTRAINT rating_description_set_product_plan_rating_description_set_fkey FOREIGN KEY (rating_description_set_id) REFERENCES public.rating_description_set(id);


--
-- Name: rating_description_set_product_plan rating_description_set_product_plan_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set_product_plan
    ADD CONSTRAINT rating_description_set_product_plan_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: rating_description_set rating_description_set_score_scale_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set
    ADD CONSTRAINT rating_description_set_score_scale_id_fkey FOREIGN KEY (score_scale_id) REFERENCES public.score_scale(id);


--
-- Name: rating_description_set rating_description_set_supersedes_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set
    ADD CONSTRAINT rating_description_set_supersedes_id_fkey FOREIGN KEY (supersedes_id) REFERENCES public.rating_description_set(id);


--
-- Name: rating_description_set rating_description_set_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating_description_set
    ADD CONSTRAINT rating_description_set_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: revenue_line_item revenue_line_item_job_activity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_line_item
    ADD CONSTRAINT revenue_line_item_job_activity_id_fkey FOREIGN KEY (job_activity_id) REFERENCES public.job_activity(id);


--
-- Name: revenue_line_item revenue_line_item_price_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_line_item
    ADD CONSTRAINT revenue_line_item_price_product_id_fkey FOREIGN KEY (price_product_id) REFERENCES public.price_product(id);


--
-- Name: revenue_line_item revenue_line_item_product_price_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_line_item
    ADD CONSTRAINT revenue_line_item_product_price_plan_id_fkey FOREIGN KEY (product_price_plan_id) REFERENCES public.product_price_plan(id);


--
-- Name: revenue_line_item revenue_line_item_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_line_item
    ADD CONSTRAINT revenue_line_item_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscription(id);
...
--
-- Name: revenue_line_item revenue_line_item_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_line_item
    ADD CONSTRAINT revenue_line_item_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: revenue_payment revenue_payment_collection_method_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_payment
    ADD CONSTRAINT revenue_payment_collection_method_id_fkey FOREIGN KEY (collection_method_id) REFERENCES public.collection_method(id);


--
-- Name: revenue_payment revenue_payment_revenue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_payment
    ADD CONSTRAINT revenue_payment_revenue_id_fkey FOREIGN KEY (revenue_id) REFERENCES public.revenue(id);
...
--
-- Name: revenue revenue_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue
    ADD CONSTRAINT revenue_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: role role_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.role
    ADD CONSTRAINT role_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: staff_attribute staff_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_attribute
    ADD CONSTRAINT staff_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: staff_attribute staff_attribute_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_attribute
    ADD CONSTRAINT staff_attribute_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
ALTER TABLE ONLY public.staff
    ADD CONSTRAINT staff_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);
...
--
-- Name: stage stage_stage_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stage
    ADD CONSTRAINT stage_stage_template_id_fkey FOREIGN KEY (stage_template_id) REFERENCES public.stage_template(id);


--
-- Name: stage_template stage_template_workflow_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stage_template
    ADD CONSTRAINT stage_template_workflow_template_id_fkey FOREIGN KEY (workflow_template_id) REFERENCES public.workflow_template(id);


--
-- Name: stage stage_workflow_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stage
    ADD CONSTRAINT stage_workflow_id_fkey FOREIGN KEY (workflow_id) REFERENCES public.workflow(id);


--
-- Name: subscription_attribute subscription_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_attribute
    ADD CONSTRAINT subscription_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: subscription_attribute subscription_attribute_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_attribute
    ADD CONSTRAINT subscription_attribute_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscription(id);
...
--
-- Name: subscription subscription_price_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription
    ADD CONSTRAINT subscription_price_plan_id_fkey FOREIGN KEY (price_plan_id) REFERENCES public.price_plan(id);
...
--
-- Name: subscription_seat subscription_seat_product_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_seat
    ADD CONSTRAINT subscription_seat_product_variant_id_fkey FOREIGN KEY (product_variant_id) REFERENCES public.product_variant(id);
...
--
-- Name: subscription_seat subscription_seat_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_seat
    ADD CONSTRAINT subscription_seat_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: subscription_workspace_user subscription_workspace_user_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_workspace_user
    ADD CONSTRAINT subscription_workspace_user_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: supplier_attribute supplier_attribute_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_attribute
    ADD CONSTRAINT supplier_attribute_attribute_id_fkey FOREIGN KEY (attribute_id) REFERENCES public.attribute(id);


--
-- Name: supplier_attribute supplier_attribute_supplier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_attribute
    ADD CONSTRAINT supplier_attribute_supplier_id_fkey FOREIGN KEY (supplier_id) REFERENCES public.supplier(id);
...
--
-- Name: supplier supplier_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier
    ADD CONSTRAINT supplier_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.supplier_category(id);
...
--
-- Name: supplier supplier_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier
    ADD CONSTRAINT supplier_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.client(id);
...
--
-- Name: supplier_contract supplier_contract_payment_term_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_contract
    ADD CONSTRAINT supplier_contract_payment_term_id_fkey FOREIGN KEY (payment_term_id) REFERENCES public.payment_term(id);
...
--
-- Name: supplier supplier_payment_term_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier
    ADD CONSTRAINT supplier_payment_term_id_fkey FOREIGN KEY (payment_term_id) REFERENCES public.payment_term(id);
...
--
-- Name: template_task_criteria_rating_description template_task_criteria_rating_description_band_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria_rating_description
    ADD CONSTRAINT template_task_criteria_rating_description_band_fkey FOREIGN KEY (score_scale_band_id) REFERENCES public.score_scale_band(id);


--
-- Name: template_task_criteria_rating_description template_task_criteria_rating_description_ttc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria_rating_description
    ADD CONSTRAINT template_task_criteria_rating_description_ttc_fkey FOREIGN KEY (template_task_criteria_id) REFERENCES public.template_task_criteria(id);


--
-- Name: template_task_criteria_rating_description template_task_criteria_rating_description_workspace_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria_rating_description
    ADD CONSTRAINT template_task_criteria_rating_description_workspace_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: template_task_criteria template_task_criteria_rating_scale_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.template_task_criteria
    ADD CONSTRAINT template_task_criteria_rating_scale_id_fkey FOREIGN KEY (rating_scale_id) REFERENCES public.score_scale(id);
...
--
-- Name: workflow_template workflow_template_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_template
    ADD CONSTRAINT workflow_template_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: workflow workflow_workflow_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow
    ADD CONSTRAINT workflow_workflow_template_id_fkey FOREIGN KEY (workflow_template_id) REFERENCES public.workflow_template(id);


--
-- Name: workflow workflow_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow
    ADD CONSTRAINT workflow_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);
...
--
-- Name: workspace_user_role workspace_user_role_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_user_role
    ADD CONSTRAINT workspace_user_role_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.role(id);


--
-- Name: workspace_user_role workspace_user_role_workspace_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_user_role
    ADD CONSTRAINT workspace_user_role_workspace_user_id_fkey FOREIGN KEY (workspace_user_id) REFERENCES public.workspace_user(id);


--
-- Name: workspace_user workspace_user_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_user
    ADD CONSTRAINT workspace_user_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);


--
-- Name: workspace_user workspace_user_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_user
    ADD CONSTRAINT workspace_user_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspace(id);


--
-- Name: workspace workspace_workflow_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace
    ADD CONSTRAINT workspace_workflow_template_id_fkey FOREIGN KEY (workflow_template_id) REFERENCES public.workflow_template(id);
