...
type Revenue struct {
	...
	WorkspaceId   *string `protobuf:"bytes,49,opt,name=workspace_id,json=workspaceId,proto3,oneof" json:"workspace_id,omitempty"`
...
func (x *Revenue) GetWorkspaceId() string {
...
const file_domain_revenue_revenue_revenue_proto_rawDesc = "" +
	...
	"\bcurrency\x18\r \x01(\tB\v\x82\xb5\x18\a\"\x05'PHP'R\bcurrency\x12%\n" +
	"\x06status\x18\x0e \x01(\tB\r\x82\xb5\x18\t\"\a'draft'R\x06status\x12.\n" +
	...
	"\x13treasury_collection\x18\x01H$R\x13advanceCollectionId\x88\x01\x01\x129\n" +
	"\fworkspace_id\x181 \x01(\tB\x11\x82\xb5\x18\r\n" +
	...
	"\x16_advance_collection_idB\x0f\n" +
	"\r_workspace_idJ\x04\b\v\x10\fJ\x04\b\x1e\x10\x1f\"\x91\x03\n" +
