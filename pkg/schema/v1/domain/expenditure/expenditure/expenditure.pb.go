...
type Expenditure struct {
	...
	WorkspaceId   *string `protobuf:"bytes,39,opt,name=workspace_id,json=workspaceId,proto3,oneof" json:"workspace_id,omitempty"`
...
func (x *Expenditure) GetWorkspaceId() string {
