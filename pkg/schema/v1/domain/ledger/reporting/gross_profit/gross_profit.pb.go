...
const file_domain_ledger_reporting_gross_profit_gross_profit_proto_rawDesc = "" +
	...
	"\x14GetGrossProfitReport\x12*.domain.ledger.v1.GrossProfitReportRequest\x1a+.domain.ledger.v1.GrossProfitReportResponseBQZOgithub.com/erniealice/esqyma/pkg/schema/v1/domain/ledger/reporting/gross_profitb\x06proto3"
